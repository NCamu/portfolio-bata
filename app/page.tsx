  ...
  return (
    ...
    duration-700"
      ...
      <section id="apropos" className="py-20 bg-white px-4 sm:px-6 lg:px-8">
        ...
        via-gray-100 
        to-fuchsia-50 
        rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow space-y-10"
          >
            {/* Introduction */}
            <p className="text-lg text-slate-700 leading-relaxed">
              ...
              contextes variés, parfois flous ou sous tension, en m’appuyant sur
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                J’explique avec des images simples quand c’est nécessaire,
                j’écoute avant de corriger et je privilégie une approche non
                conflictuelle. En équipe, je préfère dire
                <em> « on regarde ça ensemble »</em> plutôt que pointer une
                erreur, en tenant compte du niveau hiérarchique et du contexte
                émotionnel.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                J’aborde les projets avec une vision globale que je décline
                ensuite en étapes simples, testables et documentées.
                Architecture, priorisation, suivi et validation font partie
                intégrante de mon processus. En situation d’incertitude, je
                recadre les objectifs, identifie les blocages et ajuste les
                ressources selon l’avancement réel.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                Je privilégie un leadership de situation, basé sur le cadre et
                la clarté plutôt que sur l’autorité. Lorsqu’une équipe bloque,
                je redonne du sens, identifie les forces et faiblesses, puis
                structure l’action. En cas de difficulté individuelle, je
                cherche d’abord à comprendre avant d’escalader de manière
                factuelle et responsable.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                Face à un problème complexe ou intermittent, je procède par
                filtrage progressif : isolation, réduction du périmètre,
                observation, test et documentation. Mon approche est analytique,
                structurée et orientée résultats, aussi bien sur des sujets
                techniques qu’organisationnels.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                À l’aise dans les environnements changeants, je cherche toujours
                à comprendre l’intention, le cadre décisionnel et la marge de
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                l’exercice. Je mobilise documentation, veille, échanges et
                outils d’IA pour assimiler efficacement de nouveaux concepts ou
                technologies.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                Je sais défendre un point de vue sans rigidité, en privilégiant
                les questions et l’argumentation factuelle. Ma culture générale,
                nourrie par la philosophie, la fiction et l’analyse des systèmes
                complexes, influence ma manière de penser. J’utilise l’humour
                avec discernement comme outil de cohésion et de désamorçage.
              </p>
            </div>
            ...
            <div className="border-t pt-6">
              <p className="text-slate-800 font-medium leading-relaxed">
                ...
                dynamiques collectives, avec une approche pragmatique, réfléchie
                et orientée action.
              </p>
            </div>

            <button className="ml-55 px-8 py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors font-semibold flex items-center justify-center gap-2">
              <a
                href="/analyse.pdf"
                download
                className="px-8 py-3 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors font-semibold flex items-center justify-center gap-2"
